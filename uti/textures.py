...
display_screen = py.display.set_mode((960,540),py.RESIZABLE)
...
MC_FRAMES = [
    [Textures["player"]["mc_u0"], Textures["player"]["mc_u1"], Textures["player"]["mc_u2"]],
    [Textures["player"]["mc_r0"], Textures["player"]["mc_r1"], Textures["player"]["mc_r2"]],
    [Textures["player"]["mc_d0"], Textures["player"]["mc_d1"], Textures["player"]["mc_d2"]],
