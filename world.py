...
class Chunk:
    def __init__(self, chunk_pos : 'Vec', world : 'World') -> None:
        ...
        self.objects : list[list[Obj]] = [[Objs["Air"]() for k in range(CHUNK_SIZE // OBJ_SIZE)] for i in range(CHUNK_SIZE // 50)]
...
class World:
    ...
    def show(self, screen:pygame.Surface, zoom_out: int) -> None:
        ...
        for c in __chunks:
            ...
            for i in range(0, CHUNK_SIZE, 50):
                for k in range(0, CHUNK_SIZE, 50):
